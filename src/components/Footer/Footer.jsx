      ...
      <Container>
        <div className='row'>
          <div className='w-full sm:w-1/3 mb-16 text-center'>
            <h2 className='uppercase text-[clamp(24px,5vw,28px)] font-semibold mb-1'>Location</h2>
            <p>2215 John Daniel Drive</p>
            <p className='mt-4'>Clark, MO 65243</p>
          </div>
          <div className='w-full sm:w-1/3 mb-20 text-center'>
            <h2 className='uppercase text-[clamp(24px,5vw,28px)] font-semibold mb-1'>AROUND THE WEB</h2>
          ...
          <div className='w-full sm:w-1/3 mb-20 text-center'>
            <h2 className='uppercase text-[clamp(24px,5vw,28px)] font-semibold mb-1'>ABOUT FREELANCER</h2>
